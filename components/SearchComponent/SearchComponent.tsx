...
const SearchComponent: React.FC<SearchComponentProps> = ({
  ...
  return (
    <div className="rounded-lg bg-white dark:bg-dark-blue w-full md:w-4/12 flex flex-row items-center py-3 focus-within:ring-black
     dark:focus-within:ring-purple border-solid border-purple border-2 shadow-md">
      <FontAwesomeIcon
        icon={faSearch}
